...
import { ChevronLeft, Clock, Users, Flame, Utensils, Award } from 'lucide-react';
               ...
               <ul className="space-y-4">
                  {recipe.ingredients.map((ing, idx) => (
                     <li key={idx} className="flex gap-4 border-b border-emerald-900/5 pb-4 last:border-0 last:pb-0">
                        ...
                        <span className="text-slate-700 leading-relaxed font-medium">{ing}</span>
                     </li>
                  ))}
               </ul>
            </div>
